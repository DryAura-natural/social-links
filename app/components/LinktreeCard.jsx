...
const LinktreeCard = () => {
  ...
  return (
    <div className={`relative min-h-screen flex items-center justify-center p-4 transition-colors duration-500 ${darkMode ? 'bg-black' : 'bg-gray-50'}`}>
      ...
      <motion.div
        ...
        className={`relative z-10 w-full max-w-md p-8 rounded-2xl shadow-lg space-y-8 transition-all duration-500 ${darkMode ? 'bg-transparent backdrop-blur-sm border border-gray-700' : 'bg-transparent backdrop-blur-sm border border-gray-200'}`}
        whileHover={{ 
          scale: 1.01,
        ...
        <motion.div className="space-y-2" variants={containerVariants}>
          {[
            ...
            <motion.a
              ...
              className={`block p-2 rounded-xl transition-all ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-100 hover:bg-gray-200'} shadow-sm`}
              variants={itemVariants}
              whileHover={{ y: -3 }}
              whileTap={{ scale: 0.98 }}
            >
